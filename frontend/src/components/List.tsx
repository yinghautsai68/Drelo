...
const List = ({ id, index, label, cards, color, position, isEditing, handleAddCardToList }: ListProps) => {
    ...
    return (
        <Draggable key={id} index={index} draggableId={`list-${id}`}>
            {
                (provided) => (
                    <div
                        ...
                        className="flex flex-row justify-center w-[300px] max-h-[450px]  px-2 ">
